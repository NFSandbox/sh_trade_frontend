        ...
        <div className='flex flex-row items-center gap-2'>
          ...
          {contactInfo.verified &&
            <InlineTag
              ...
              icon={<GoVerified
                size={16} />}
              toolTip='此联系方式曾经成功通过平台验证'>已验证</InlineTag>}
        </div>
        ...
        {props.onRemove && (
          <div className='px-4 justify-self-end'>
            <Button type='default' onClick={(e) => {
              ...
              // trigger onremove callback if exists
              if (props.onRemove)
                props.onRemove(contactInfo);
            }}>
...
function InlineTag(props: InlineTagProps) {
  let content = (
    <span className={classNames(
      ...
      {props.icon ?? undefined}{props.children}
    </span>
  );
